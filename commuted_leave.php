...
<html>
  ...
  <body>
    <div class="container">
      <h1 class="form-title">Apply for Commuted leave</h1>
      <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"  action="commuted_leave.php" method="post" enctype="multipart/form-data">
