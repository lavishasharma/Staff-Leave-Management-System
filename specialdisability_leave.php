...
<?php
	...
	session_start();
    $emp_id=$_SESSION['eid'];
    $sql = "SELECT disabiltiy_leaves FROM employee WHERE emp_id='$emp_id'";
...
<html>
  ...
  <body>
    <div class="container">
      <h1 class="form-title">Apply for Specialdisability leave</h1>
      <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"  action="specialdisability_leave.php" method="post" enctype="multipart/form-data">
