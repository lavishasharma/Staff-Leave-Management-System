...
if(isset($_REQUEST['pwdrst']))
{
  ...
  if($pwd == $cpwd)
  {
    $reset_pwd = mysqli_query($con,"update employee set password='$pwd' where email='$email'");
    if($reset_pwd>0)
    {
      $msg = 'Your password updated successfully <a href="login4.php">Click here</a> to login';
    }
    else
    {
...
if($_GET['secret'])
{
  ...
  $check_details = mysqli_query($con,"select email from employee where email='$email';");
