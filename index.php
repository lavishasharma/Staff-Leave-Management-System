...
<body class="bg-light">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark bg-gradient" id="topNavBar">
        <div class="container">
            ...
            <div>
                <a  class="text-light" href="admin_index.php">Back to Dashboard</a>
            </div>
        </div>
    </nav>
                        ...
                        <div class="container-fluid">
                            <form action="save_schedule.php" method="post" id="schedule-form">
                                ...
                                <div class="form-group mb-2">
                                    <label for="title" class="control-label">Holiday Name</label>
...
<?php 
$schedules = $con->query("SELECT * FROM `holiday_list`");
$sched_res = [];
